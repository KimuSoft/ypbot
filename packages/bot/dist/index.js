...
client.on('ready', () => {
    console.log(chalk.blue(`Logged in as ${chalk.green(`${client.user.username}#${client.user.discriminator}`)}`));
});
...
let waitIdentifyResolve;
const waitIdentify = new Promise((resolve) => {
