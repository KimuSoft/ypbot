...
const RulesSidebarList: React.FC = () => {
    return (
        <SidebarGroup title="내 규칙" icon={FaTag}>
            <SidebarLink path="/rules" title="내 규칙 목록" icon={FaCog} />
            <SidebarLink path="/rules/browse" title="규칙 찾아보기" icon={FaCog} />
            <SidebarLink path="/rules/new" title="새 커스텀 규칙 만들기" icon={FaCog} />
        </SidebarGroup>
    )
}
